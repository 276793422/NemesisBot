...
func RegisterDefaultHandlers(clusterHandler Logger, getNodeID func() string, getCapabilities func() []string, getOnlinePeers func() []interface{}, registrar Registrar) {
	// Ping handler
	...
	clusterHandler.LogRPCInfo("Registered default handlers: ping, get_capabilities, get_info")
}
