...
// Package utils provides HTTP retry utility functions for resilient network operations.
package utils
...
// It retries on transient failures (429 Too Many Requests, 5xx server errors)
// with exponential backoff. The retry can be cancelled via the request context.
